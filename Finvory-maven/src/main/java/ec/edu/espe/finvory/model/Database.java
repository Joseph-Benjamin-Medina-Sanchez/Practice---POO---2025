...
public class Database {
    ...
    private void loadConfigurationsFromCloud(FinvoryData data, String username) {
        ...
        data.setTaxRate(BigDecimal.valueOf(getDoubleSafe(doc, "taxRate", data.getTaxRate() != null ? data.getTaxRate().doubleValue() : 0.0)));
        data.setProfitPercentage(BigDecimal.valueOf(getDoubleSafe(doc, "profitPercentage", data.getProfitPercentage() != null ? data.getProfitPercentage().doubleValue() : 0.0)));
        data.setDiscountStandard(BigDecimal.valueOf(getDoubleSafe(doc, "discountStandard", data.getDiscountStandard() != null ? data.getDiscountStandard().doubleValue() : 0.0)));
        data.setDiscountPremium(BigDecimal.valueOf(getDoubleSafe(doc, "discountPremium", data.getDiscountPremium() != null ? data.getDiscountPremium().doubleValue() : 0.0)));
        data.setDiscountVip(BigDecimal.valueOf(getDoubleSafe(doc, "discountVip", data.getDiscountVip() != null ? data.getDiscountVip().doubleValue() : 0.0)));
    }
    ...
    private static int getIntSafe(Document doc, String key, int def) {
        if (doc == null) return def;
        Object v = doc.get(key);
        return toInt(v, def);
    }
